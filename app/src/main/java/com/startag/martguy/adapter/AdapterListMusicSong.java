package com.startag.martguy.adapter;
...
public class AdapterListMusicSong extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListMusicSong(Context context, List<MusicSongOnline> items, int menures) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_music_grid, parent, false);
